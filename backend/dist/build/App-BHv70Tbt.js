...
`,Xo=j(Ve)`
  flex: 1;
  min-width: 0;
`,Jo=({folder:e,orderedItemKeys:s})=>{const{formatMessage:n}=T(),{navigateToFolder:a}=He(),{isMovePending:r}=ue()??{isMovePending:!1},{isSelected:o,toggle:i,selectRange:d}=me(),{canUpdate:u}=ce(),{dragData:f,draggable:{attributes:g,listeners:h,setNodeRef:y,isDragging:p},droppable:{setNodeRef:m},showValidDropHighlight:M,showInvalidDropCursor:v}=On(e),C=je(e.id),$=w=>{y(w),m(w)},x=w=>{te(w)&&(w.shiftKey?d(s,C):w.metaKey||w.ctrlKey?i(C):a(e))},I=w=>{te(w)&&(w.key==="Enter"?(w.preventDefault(),a(e)):w.key===" "&&(w.preventDefault(),i(C)))},A=w=>{w.stopPropagation(),w.shiftKey?d(s,C):i(C)};return t.jsxs(Qo,{ref:$,...g,...h,$isDragging:p,$isMovePending:r,$isValidDropTarget:M,$isInvalidDropTarget:v,$isSelected:o(C),onClick:x,onKeyDown:I,onPointerDown:w=>{te(w)&&h?.onPointerDown?.(w)},role:"listitem",tabIndex:0,children:[u&&t.jsx(S,{onKeyDown:w=>w.stopPropagation(),children:t.jsx(ke,{checked:o(C),onClick:A,"aria-label":n({id:l("list.table.row.select"),defaultMessage:"Select {name}"},{name:e.name})})}),t.jsx(Zo,{children:t.jsx(ve,{width:20,height:20})}),t.jsx(Xo,{textColor:"neutral800",children:e.name}),t.jsx(S,{onClick:Ee,onKeyDown:Ee,onPointerDown:Ee,children:t.jsx(Nn,{folder:e,dragData:f})})]})},vs=j(_)`
  position: relative;
  width: 100%;
  padding-bottom: 62.5%;
  height: 0;
...
`,de=e=>{te(e)&&e.stopPropagation()},bi=({asset:e})=>{const{ext:s,mime:n}=e,a=Ke(n,s);return t.jsx(S,{justifyContent:"center",alignItems:"center",borderRadius:"4px",color:"neutral500",width:"3.2rem",height:"3.2rem",shrink:0,children:t.jsx(a,{width:20,height:20})})},Ds=({asset:e,orderedItemKeys:s,onAssetItemClick:n})=>{const a=Yt(),{formatDate:r,formatMessage:o}=T(),{isMovePending:i}=ue()??{isMovePending:!1},{attributes:d,listeners:u,setNodeRef:f,isDragging:g,dragData:h}=Ln(e),{isSelected:y,toggle:p,selectRange:m}=me(),{canUpdate:M}=ce(),v=ss()?.getBusyMessage(e.id)??null,C=be(e.id),$=y(C),x=!e.caption||!e.alternativeText,I=o({id:l("list.table.row.metadata-missing"),defaultMessage:"This asset is missing metadata (caption or alternative text)."}),A=R=>{te(R)&&(R.shiftKey?m(s,C):R.metaKey||R.ctrlKey?p(C):n(e.id))},w=R=>{te(R)&&(R.key==="Enter"?(R.preventDefault(),n(e.id)):R.key===" "&&(R.preventDefault(),p(C)))},k=R=>{R.stopPropagation(),n(e.id)},B=R=>{R.stopPropagation(),R.shiftKey?m(s,C):p(C)};return t.jsxs(_n,{ref:f,...d,...u,$isDragging:g,$isMovePending:i,$isBusy:v!==null,$isSelected:$,tabIndex:0,role:"row",onDragStart:R=>R.preventDefault(),onClick:A,onKeyDown:w,onPointerDown:R=>{te(R)&&u?.onPointerDown?.(R)},children:[M&&t.jsx(Un,{onClick:de,onKeyDown:de,children:t.jsx(S,{children:t.jsx(ke,{checked:$,onClick:B,"aria-label":o({id:l("list.table.row.select"),defaultMessage:"Select {name}"},{name:e.name})})})}),t.jsx(oe,{children:t.jsxs(S,{alignItems:"center",justifyContent:"space-between",gap:2,minWidth:0,children:[t.jsxs(S,{gap:3,alignItems:"center",minWidth:0,children:[v!==null?t.jsx(S,{justifyContent:"center",width:"3.2rem",height:"3.2rem",children:t.jsx(Ce,{small:!0,children:v})}):t.jsx(bi,{asset:e}),t.jsxs(S,{direction:"column",alignItems:"flex-start",minWidth:0,children:[t.jsx(yi,{type:"button",onClick:k,children:t.jsx(Ve,{textColor:"neutral800",fontWeight:"semiBold",children:e.name})}),!a&&t.jsx(E,{textColor:"neutral600",variant:"pi",children:e.size?Pt(e.size,1):"-"})]})]}),x&&t.jsx(ct,{label:I,children:t.jsx(xi,{"aria-label":I,role:"img"})})]})}),a&&t.jsxs(t.Fragment,{children:[t.jsx(oe,{children:t.jsx(E,{textColor:"neutral600",children:e.createdAt?r(new Date(e.createdAt),{dateStyle:"long"}):"-"})}),t.jsx(oe,{children:t.jsx(E,{textColor:"neutral600",children:e.updatedAt?r(new Date(e.updatedAt),{dateStyle:"long"}):"-"})}),t.jsx(oe,{children:t.jsx(E,{textColor:"neutral600",children:e.size?Pt(e.size,1):"-"})})]}),t.jsx(oe,{onClick:de,onKeyDown:de,onPointerDown:de,children:t.jsx(S,{justifyContent:"flex-end",children:t.jsx(Fn,{asset:e,dragData:h})})})]})},ji=j(_n)`
  &:hover {
    background: ${({theme:e})=>e.colors.primary100};
  }
`,Is=({folder:e,orderedItemKeys:s})=>{const n=Yt(),{formatDate:a,formatMessage:r}=T(),{navigateToFolder:o}=He(),{isSelected:i,toggle:d,selectRange:u}=me(),{canUpdate:f}=ce(),{isMovePending:g}=ue()??{isMovePending:!1},{dragData:h,draggable:{attributes:y,listeners:p,setNodeRef:m,isDragging:M},droppable:{setNodeRef:v},showValidDropHighlight:C,showInvalidDropCursor:$}=On(e),x=je(e.id),I=k=>{te(k)&&(k.shiftKey?u(s,x):k.metaKey||k.ctrlKey?d(x):o(e))},A=k=>{te(k)&&(k.key==="Enter"?(k.preventDefault(),o(e)):k.key===" "&&(k.preventDefault(),d(x)))},w=k=>{k.stopPropagation(),k.shiftKey?u(s,x):d(x)};return t.jsxs(ji,{ref:k=>{m(k),v(k)},...y,...p,$isDragging:M,$isMovePending:g,$isValidDropTarget:C,$isInvalidDropTarget:$,$isSelected:i(x),tabIndex:0,role:"row",onDragStart:k=>{te(k)&&k.preventDefault()},onClick:I,onKeyDown:A,onPointerDown:k=>{te(k)&&p?.onPointerDown?.(k)},children:[f&&t.jsx(Un,{onClick:de,onKeyDown:de,children:t.jsx(S,{children:t.jsx(ke,{checked:i(x),onClick:w,"aria-label":r({id:l("list.table.row.select"),defaultMessage:"Select {name}"},{name:e.name})})})}),t.jsx(oe,{children:t.jsxs(S,{gap:3,alignItems:"center",minWidth:0,children:[t.jsx(S,{justifyContent:"center",alignItems:"center",borderRadius:"4px",color:"neutral600",width:"3.2rem",height:"3.2rem",shrink:0,children:t.jsx(ve,{width:20,height:20})}),t.jsx(Ve,{textColor:"neutral800",fontWeight:"semiBold",children:e.name})]})}),n&&t.jsxs(t.Fragment,{children:[t.jsx(oe,{children:t.jsx(E,{textColor:"neutral600",children:e.createdAt?a(new Date(e.createdAt),{dateStyle:"long"}):"-"})}),t.jsx(oe,{children:t.jsx(E,{textColor:"neutral600",children:e.updatedAt?a(new Date(e.updatedAt),{dateStyle:"long"}):"-"})}),t.jsx(oe,{children:t.jsx(E,{textColor:"neutral600",children:"-"})})]}),t.jsx(oe,{onClick:de,onKeyDown:de,onPointerDown:de,children:t.jsx(S,{justifyContent:"flex-end",children:t.jsx(Nn,{folder:e,dragData:h})})})]})},wi=({assets:e,folders:s=[],mixedItems:n=null,onAssetItemClick:a})=>{const r=Yt(),{formatMessage:o}=T(),{selectedKeys:i,selectAll:d,clear:u}=me(),{canUpdate:f}=ce(),{trackUsage:g}=$e(),h=r?Ss:Ss.filter(x=>x.name==="name"||x.name==="actions"),y=f,p=h.length+(y?1:0),m=s.length+e.length,M=n?n.map(x=>x.kind==="folder"?je(x.folder.id):be(x.asset.id)):[...s.map(x=>je(x.id)),...e.map(x=>be(x.id))],{allSelected:v,isIndeterminate:C}=Co(i,M),$=()=>{v?u():(g("didSelectAllMediaLibraryElements"),d(M))};return m===0?null:t.jsxs(hi,{colCount:p,rowCount:(n?n.length:m)+1,children:[t.jsx(fi,{children:t.jsxs(Aa,{children:[y&&t.jsx(mi,{children:t.jsx(S,{children:t.jsx(ke,{checked:C?"indeterminate":v,disabled:M.length===0,onCheckedChange:$,"aria-label":o({id:l("list.table.header.select-all"),defaultMessage:"Select all"})})})}),h.map(x=>{const I=o(x.label);return"isVisuallyHidden"in x&&x.isVisuallyHidden?t.jsx(Nt,{children:t.jsx(Ie,{children:o({id:l("table.header.actions"),defaultMessage:"actions"})})},x.name):t.jsx(Nt,{children:t.jsx(E,{textColor:"neutral600",variant:"sigma",children:I})},x.name)})]})}),t.jsxs(Fa,{children:[n?.map(x=>x.kind==="folder"?t.jsx(Is,{folder:x.folder,orderedItemKeys:M},`folder-${x.folder.id}`):t.jsx(Ds,{asset:x.asset,orderedItemKeys:M,onAssetItemClick:a},x.asset.id)),!n&&s.map(x=>t.jsx(Is,{folder:x,orderedItemKeys:M},`folder-${x.id}`)),!n&&e.map(x=>t.jsx(Ds,{asset:x,orderedItemKeys:M,onAssetItemClick:a},x.id))]})]})},Mi=(e,s,n,a)=>{const r=[];return e.forEach(o=>{r.push({kind:"file",id:o,name:"",folderId:lt(n,"file",o,a)})}),s.forEach(o=>{r.push({kind:"folder",id:o,name:"",parentId:lt(n,"folder",o,a)})}),r},Ci=j(S)`
  position: fixed;
...
`,ki=({children:e,onDrop:s,disabled:n=!1})=>{const[a,r]=c.useState(!1),o=c.useRef(0),i={isDragging:a};c.useEffect(()=>{const h=()=>{r(!1),o.current=0},y=p=>{p.relatedTarget||(r(!1),o.current=0)};return document.addEventListener("dragend",h),document.addEventListener("dragleave",y),()=>{document.removeEventListener("dragend",h),document.removeEventListener("dragleave",y)}},[]);const d=c.useCallback(h=>{h.preventDefault(),h.stopPropagation(),!n&&h.dataTransfer.types.includes("Files")&&(o.current+=1,r(!0))},[n]),u=c.useCallback(h=>{h.preventDefault(),h.stopPropagation(),o.current-=1,o.current<=0&&(r(!1),o.current=0)},[]),f=c.useCallback(h=>{h.preventDefault(),h.stopPropagation(),h.dataTransfer.dropEffect="copy"},[]),g=c.useCallback(h=>{if(h.preventDefault(),h.stopPropagation(),r(!1),o.current=0,n)return;const{files:y}=h.dataTransfer;y?.length&&s&&s(Array.from(y))},[s,n]);return t.jsx(zn.Provider,{value:i,children:t.jsx(Ii,{"data-testid":"assets-dropzone",onDragEnter:d,onDragLeave:u,onDragOver:f,onDrop:g,children:e})})},Kn=()=>{const e=c.useContext(zn);if(!e)throw new Error("useUploadDropZone must be used within UploadDropZone");return{isDragging:e.isDragging}},$i=(e,s)=>`${e}${Math.floor(s*255).toString(16).padStart(2,"0")}`,Ai=j(_)`
  ...
  z-index: 1;
  pointer-events: none;
`,Fi=({children:e})=>{const{isDragging:s}=Kn(),a=ue()?.isInternalDragActive??!1,r=s&&!a;return t.jsxs(_,{position:"relative",children:[r&&t.jsx(Ai,{}),e]})},Ei=j(_)`
  position: fixed;
  ...
  border-radius: ${({theme:e})=>e.borderRadius};
  z-index: 2;
`,Ri=({uploadDropZoneRef:e,folderName:s})=>{const{formatMessage:n}=T(),{isDragging:a}=Kn(),o=ue()?.isInternalDragActive??!1,i=a&&!o,[d,u]=c.useState(0);return c.useEffect(()=>{if(!e?.current)return;const f=()=>{const h=e.current?.getBoundingClientRect();h&&u(y=>y!==h.left?h.left:y)};f();const g=new ResizeObserver(f);return g.observe(e.current),()=>g.disconnect()},[e]),i?t.jsxs(Ei,{$leftContentWidth:d,children:[t.jsx(E,{textColor:"neutral0",children:n({id:l("dropzone.upload.message"),defaultMessage:"Drop here to upload to"})}),t.jsxs(S,{gap:2,alignItems:"center",children:[t.jsx(ve,{width:20,height:20,fill:"neutral0"}),t.jsx(E,{textColor:"neutral0",fontWeight:"semiBold",children:s})]})]}):null},Ti=({onAddAssets:e,canAddAssets:s,searchQuery:n,onClearSearch:a})=>{const{formatMessage:r}=T(),o=!!n;return t.jsxs(S,{direction:"column",alignItems:"center",gap:6,padding:11,children:[t.jsx(on,{width:"16rem",height:"8.8rem"}),t.jsxs(S,{direction:"column",alignItems:"center",gap:2,textAlign:"center",children:[t.jsx(E,{variant:"delta",tag:"p",fontWeight:"bold",textColor:"neutral800",children:r(o?{id:l("list.search.empty.title"),defaultMessage:"No results found"}:{id:l("list.empty.title"),defaultMessage:"No assets yet"})}),t.jsx(E,{textColor:"neutral600",children:o?r({id:l("list.search.empty.description"),defaultMessage:'No assets or folders match "{query}". Try a different search.'},{query:n}):r({id:l("list.empty.description"),defaultMessage:"Get started by uploading assets or creating a folder."})})]}),o?t.jsx(G,{variant:"secondary",startIcon:t.jsx(pt,{"aria-hidden":!0}),onClick:a,children:r({id:l("list.search.empty.clear"),defaultMessage:"Clear search"})}):s&&t.jsx(G,{onClick:e,children:r({id:l("list.empty.add-assets"),defaultMessage:"Add assets"})})]})},Li=({onClearFilters:e})=>{const{formatMessage:s}=T();return t.jsxs(S,{direction:"column",alignItems:"center",gap:6,padding:11,children:[t.jsx(on,{width:"16rem",height:"8.8rem"}),t.jsx(E,{textColor:"neutral600",children:s({id:l("list.filters.empty"),defaultMessage:"No items matched current filters"})}),t.jsx(G,{variant:"secondary",startIcon:t.jsx(pt,{"aria-hidden":!0}),onClick:e,children:s({id:l("list.filters.clear"),defaultMessage:"Clear filters"})})]})},os=["folder","picture","audio","video","document"],is=["1day","3days","1week","1month","3months","6months","1year"],Oi={created:"createdAt",updated:"updatedAt"},Pi={createdAt:"created",updatedAt:"updated"},ks={exact:"isExactly",within:"withinLast",notwithin:"notWithinLast"},Ni={isExactly:"exact",withinLast:"within",notWithinLast:"notwithin"},$s={rangeis:"is",rangenot:"isNot"},Bi={is:"rangeis",isNot:"rangenot"},As=/^\d{4}-\d{2}-\d{2}$/,_i=e=>os.includes(e),Ui=e=>is.includes(e),zi=e=>{const[s,n,a]=e.split(":");if(!s||!n||!a)return null;if(s==="type"){if(n!=="is"&&n!=="not")return null;const o=a.split(",").filter(_i);return o.length>0?{kind:"type",condition:n==="is"?"is":"isNot",values:o}:null}const r=Oi[s];if(!r)return null;if(n in ks)return Ui(a)?{kind:"date",field:r,mode:"preset",condition:ks[n],preset:a}:null;if(n in $s){const[o,i]=a.split("..");return As.test(o??"")&&As.test(i??"")?{kind:"date",field:r,mode:"range",condition:$s[n],from:o,to:i}:null}return null},Ki=e=>typeof e!="string"||e===""?[]:e.split(";").map(zi).filter(s=>s!==null),Vi=e=>{if(e.kind==="type")return`type:${e.condition==="is"?"is":"not"}:${e.values.join(",")}`;const s=Pi[e.field];return e.mode==="preset"?`${s}:${Ni[e.condition]}:${e.preset}`:`${s}:${Bi[e.condition]}:${e.from}..${e.to}`},Fs=e=>e.map(Vi).join(";"),Hi=()=>{const[{query:e},s]=De(),n=Ki(e?.filters),a=r=>{r.length===0?s({filters:""},"remove",!0):s({filters:Fs(r)},"push",!0)};return{filters:n,serialized:Fs(n),addFilter:r=>a([...n,r]),updateFilter:(r,o)=>a(n.map((i,d)=>d===r?o:i)),removeFilter:r=>a(n.filter((o,i)=>i!==r)),clearFilters:()=>a([])}},Bt={picture:"image",audio:"audio",video:"video"},Es=Object.values(Bt),Wi={"1day":{days:1},"3days":{days:3},"1week":{days:7},"1month":{months:1},"3months":{months:3},"6months":{months:6},"1year":{years:1}},qi=(e,s)=>{const{days:n=0,months:a=0,years:r=0}=Wi[s],o=new Date(e.getTime());if(r||a){const i=o.getDate();o.setDate(1),o.setFullYear(o.getFullYear()-r),o.setMonth(o.getMonth()-a);const d=new Date(o.getFullYear(),o.getMonth()+1,0).getDate();o.setDate(Math.min(i,d))}return o.setDate(o.getDate()-n),o},Rs=e=>{const s=new Date(e.getTime());return s.setHours(0,0,0,0),s},Ts=e=>{const s=new Date(e.getTime());return s.setHours(23,59,59,999),s},dt=e=>{const[s,n,a]=e.split("-").map(Number);return new Date(s,n-1,a)},Gi=(e,s)=>{const{field:n}=e;if(e.mode==="preset"){const o=qi(s,e.preset);switch(e.condition){case"withinLast":return{[n]:{$gte:o.toISOString()}};case"notWithinLast":return{[n]:{$lt:o.toISOString()}};case"isExactly":return{[n]:{$gte:Rs(o).toISOString(),$lte:Ts(o).toISOString()}}}}const a=Rs(dt(e.from)).toISOString(),r=Ts(dt(e.to)).toISOString();return e.condition==="is"?{[n]:{$gte:a,$lte:r}}:{$or:[{[n]:{$lt:a}},{[n]:{$gt:r}}]}},Yi=e=>{const s=e.values.filter(r=>r!=="folder");if(s.length===0)return null;const n=s.map(r=>r==="document"?{$and:Es.map(o=>({mime:{$notContains:o}}))}:{mime:{$contains:Bt[r]}});if(e.condition==="is")return n.length===1?n[0]:{$or:n};const a=s.map(r=>r==="document"?{$or:Es.map(o=>({mime:{$contains:o}}))}:{mime:{$notContains:Bt[r]}});return a.length===1?a[0]:{$and:a}},Qi=(e,s)=>{const n=[],a=[];let r=!0,o=!0;for(const i of e){if(i.kind==="date"){const f=Gi(i,s);n.push(f),a.push(f);continue}const d=i.values.includes("folder");(i.condition==="is"?!d:d)&&(r=!1);const u=Yi(i);u?n.push(u):i.condition==="is"&&(o=!1)}return{fileClauses:n,folderClauses:a,showFolders:r,showFiles:o}},Zi=j.button`
  width: 3rem;
  height: 3rem;
  border: none;
  border-radius: ${({theme:e})=>e.borderRadius};
...
`,Ps={is:{id:l("list.filters.condition.is"),defaultMessage:"is"},isNot:{id:l("list.filters.condition.is-not"),defaultMessage:"is not"}},Ns={isExactly:{id:l("list.filters.condition.is-exactly"),defaultMessage:"is exactly"},withinLast:{id:l("list.filters.condition.within-last"),defaultMessage:"within the last"},notWithinLast:{id:l("list.filters.condition.not-within-last"),defaultMessage:"not within the last"}},Bs={is:{id:l("list.filters.condition.is"),defaultMessage:"is"},isNot:{id:l("list.filters.condition.is-not"),defaultMessage:"is not"}},Rt=({label:e,options:s,active:n,getOptionLabel:a,onPick:r})=>{const[o,i]=c.useState(!1);return t.jsxs(Se.Root,{open:o,onOpenChange:i,children:[t.jsx(Se.Trigger,{children:t.jsx(ls,{type:"button",$interactive:!0,children:t.jsx(E,{variant:"pi",textColor:"neutral800",children:e})})}),t.jsx(ds,{children:t.jsx(S,{direction:"column",alignItems:"stretch",padding:1,children:s.map(d=>t.jsxs(Vn,{type:"button",onClick:()=>{r(d),i(!1)},children:[a(d),d===n&&t.jsx(ft,{"aria-hidden":!0,width:"1.6rem",height:"1.6rem"})]},d))})})]})},ol=({filter:e,onChange:s})=>{const{formatMessage:n}=T(),[a,r]=c.useState(!1),o=e.values.map(d=>n(Ut[d])).join(", "),i=d=>{const u=e.values.includes(d)?e.values.filter(f=>f!==d):[...e.values,d];u.length>0&&s({...e,values:u})};return t.jsxs(Se.Root,{open:a,onOpenChange:r,children:[t.jsx(Se.Trigger,{children:t.jsx(ls,{type:"button",$interactive:!0,children:t.jsx(E,{variant:"pi",textColor:"neutral800",children:o})})}),t.jsx(ds,{children:t.jsx(S,{direction:"column",alignItems:"flex-start",padding:3,gap:2,children:os.map(d=>t.jsx(ke,{checked:e.values.includes(d),onCheckedChange:()=>i(d),children:n(Ut[d])},d))})})]})},_s=({filter:e,onChange:s})=>{const{formatMessage:n,formatDate:a}=T(),[r,o]=c.useState(!1),i=e.mode==="preset"?n(zt[e.preset]):`${a(dt(e.from),{day:"2-digit",month:"short"})} - ${a(dt(e.to),{day:"2-digit",month:"short",year:"numeric"})}`;return t.jsxs(Se.Root,{open:r,onOpenChange:o,children:[t.jsx(Se.Trigger,{children:t.jsx(ls,{type:"button",$interactive:!0,children:t.jsx(E,{variant:"pi",textColor:"neutral800",children:i})})}),t.jsx(ds,{children:e.mode==="preset"?t.jsx(S,{direction:"column",alignItems:"stretch",padding:1,children:is.map(d=>t.jsxs(Vn,{type:"button",onClick:()=>{s({...e,preset:d}),o(!1)},children:[n(zt[d]),d===e.preset&&t.jsx(ft,{"aria-hidden":!0,width:"1.6rem",height:"1.6rem"})]},d))}):t.jsx(_t,{from:e.from,to:e.to,onSelect:(d,u)=>{s({...e,from:d,to:u}),o(!1)}})})]})},il=({filter:e,onChange:s,onRemove:n})=>{const{formatMessage:a}=T(),r=e.kind==="type"?a({id:l("list.filters.field.type"),defaultMessage:"Type"}):a(Kt[e.field]);return t.jsxs(nl,{alignItems:"stretch","data-testid":"filter-badge",children:[t.jsx(al,{children:t.jsx(E,{variant:"pi",textColor:"neutral600",children:r})}),e.kind==="type"&&t.jsxs(t.Fragment,{children:[t.jsx(Rt,{label:a(Ps[e.condition]),options:["is","isNot"],active:e.condition,getOptionLabel:o=>a(Ps[o]),onPick:o=>s({...e,condition:o})}),t.jsx(ol,{filter:e,onChange:s})]}),e.kind==="date"&&e.mode==="preset"&&t.jsxs(t.Fragment,{children:[t.jsx(Rt,{label:a(Ns[e.condition]),options:["isExactly","withinLast","notWithinLast"],active:e.condition,getOptionLabel:o=>a(Ns[o]),onPick:o=>s({...e,condition:o})}),t.jsx(_s,{filter:e,onChange:s})]}),e.kind==="date"&&e.mode==="range"&&t.jsxs(t.Fragment,{children:[t.jsx(Rt,{label:a(Bs[e.condition]),options:["is","isNot"],active:e.condition,getOptionLabel:o=>a(Bs[o]),onPick:o=>s({...e,condition:o})}),t.jsx(_s,{filter:e,onChange:s})]}),t.jsx(rl,{type:"button",onClick:n,"aria-label":a({id:l("list.filters.remove"),defaultMessage:"Remove {filter} filter"},{filter:r}),children:t.jsx(pt,{width:"1.2rem",height:"1.2rem","aria-hidden":!0})})]})},ll=j(S)`
  padding-top: ${({theme:e,$compact:s})=>s?e.spaces[1]:e.spaces[6]};
  transition: padding-top 0.2s ease;
`,dl=({listFilters:e,compact:s=!1})=>{const{filters:n,updateFilter:a,removeFilter:r}=e;return n.length===0?null:t.jsx(ll,{$compact:s,gap:2,wrap:"wrap","data-testid":"filter-badges",children:n.map((o,i)=>t.jsx(il,{filter:o,onChange:d=>a(i,d),onRemove:()=>r(i)},i))})},Hn=e=>{const{isMovePending:s,isValidDropTarget:n}=ue()??{isMovePending:!1,isValidDropTarget:()=>!1},{active:a}=dn(),r=e.id==null?En:Bo(e.id),o={kind:"folder-tree-target",id:e.id,name:e.name},i=un({id:r,data:o,disabled:s}),d=n(e.id),u=i.isOver;return{droppable:i,isOver:u,showValidDropHighlight:u&&d,showInvalidDropCursor:u&&!d&&a!=null}},cl=600,ul=({isOver:e,canExpand:s,onExpand:n})=>{c.useEffect(()=>{if(!e||!s)return;const a=setTimeout(n,cl);return()=>clearTimeout(a)},[e,s,n])},Wn=j.button`
  display: flex;
  align-items: center;
  gap: ${({theme:e})=>e.spaces[2]};
  width: 100%;
