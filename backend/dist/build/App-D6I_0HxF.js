...
`,Wr=()=>t.jsx(Hr,{children:t.jsx("svg",{width:"17",height:"49",viewBox:"0 0 17 49",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:t.jsx("path",{d:"M0.5 0.5H8.5C12.9183 0.5 16.5 4.08172 16.5 8.5M0.5 48.5H8.5C12.9183 48.5 16.5 44.9183 16.5 40.5",stroke:"#666687",strokeLinecap:"round"})})}),qr=({asset:e,isBusy:s=!1,onClose:n,onApply:a,onSaveAsCopy:r,canSaveAsCopy:o})=>{const{formatMessage:i}=T(),{toggleNotification:d}=fe(),f=ga().colorScheme==="dark",g=f?"neutral1000":"neutral0",h=f?"neutral600":"neutral200",y=c.useRef(null),p=c.useRef(null),m=c.useRef(null);c.useEffect(()=>{m.current?.focus()},[]);const{init:M,crop:v,naturalSize:C,aspectRatio:$,setCropSize:x,setCropPosition:D,setAspectRatio:A,produceFile:w,width:k,height:N}=Or(),[E,Y]=c.useState(!1),[L,b]=c.useState(e.focalPoint??{x:50,y:50}),I=he(e.url),F=e.updatedAt&&!e.isUrlSigned?new Date(e.updatedAt).getTime():void 0,U=F!==void 0?`${I}${I.includes("?")?"&":"?"}updatedAt=${F}`:I,V=()=>{y.current&&M(y.current)},H=O=>{const W=p.current?.getBoundingClientRect();if(!W||!C.width||!C.height)return null;const K=C.width/W.width,se=C.height/W.height;return{x:(O.clientX-W.left)*K,y:(O.clientY-W.top)*se}},P=c.useRef(null);c.useEffect(()=>()=>{P.current?.()},[]);const q=(O,W)=>{O.preventDefault(),O.stopPropagation();const{pointerId:K}=O;try{O.currentTarget.setPointerCapture(K)}catch{}const se=re=>{re.pointerId===K&&W(re)},ne=()=>{window.removeEventListener("pointermove",se),window.removeEventListener("pointerup",pe),window.removeEventListener("pointercancel",pe),P.current=null},pe=re=>{re.pointerId===K&&ne()};P.current?.(),P.current=ne,window.addEventListener("pointermove",se),window.addEventListener("pointerup",pe),window.addEventListener("pointercancel",pe)},Q=O=>{const W=H(O);if(!W)return;const K={...v};q(O,se=>{const ne=H(se);ne&&D({x:K.x+(ne.x-W.x),y:K.y+(ne.y-W.y)})})},ie=O=>W=>{const K={...v},se=O==="tl"||O==="bl"?K.x+K.width:K.x,ne=O==="tl"||O==="tr"?K.y+K.height:K.y;q(W,pe=>{const re=H(pe);if(!re)return;const{x:Ye,y:Qe,width:yt,height:bt}=Lr({anchorX:se,anchorY:ne,point:re,aspectRatio:E?$:null});D({x:Ye,y:Qe}),x({width:yt,height:bt})})},xe=()=>{Y(O=>{const W=!O;return A(W&&N?k/N:null),W})},ge=O=>{q(O,W=>{const K=H(W);if(!K)return;const se=(K.x-v.x)/v.width*100,ne=(K.y-v.y)/v.height*100;b({x:Math.round(Math.min(100,Math.max(0,se))),y:Math.round(Math.min(100,Math.max(0,ne)))})})},We=Math.round(L.x/100*k),qe=Math.round(L.y/100*N),Le=(O,W)=>{const K=O==="x"?k:N;if(!K)return;const se=Math.min(100,Math.max(0,W/K*100));b(ne=>({...ne,[O]:Math.round(se)}))},le=C.width&&C.height?{left:v.x/C.width*100,top:v.y/C.height*100,width:v.width/C.width*100,height:v.height/C.height*100}:null,Oe=le!==null,Ge=async O=>{if(!Oe)return;let W;try{W=await w(e.name,e.mime??"image/png",e.updatedAt)}catch{d({type:"danger",message:i({id:l("asset-details.crop.export-error"),defaultMessage:"Could not process the cropped image."})});return}const K={x:Math.round(L.x),y:Math.round(L.y)};O==="apply"?a(W,K):r(W,K)};return t.jsx(pa,{children:t.jsx(ha,{onEscape:n,skipAutoFocus:!0,children:t.jsxs(Pr,{ref:m,tabIndex:-1,children:[t.jsxs(Br,{alignItems:"center",children:[t.jsx(Xs,{"aria-hidden":!0}),t.jsx(R,{variant:"omega",fontWeight:"bold",children:i({id:l("asset-details.crop.title"),defaultMessage:"Crop & Focus area"})})]}),t.jsxs(Nr,{children:[t.jsxs(_r,{ref:p,$aspect:C.width&&C.height?C.width/C.height:void 0,children:[t.jsx("img",{ref:y,src:U,alt:e.name,crossOrigin:"anonymous",onLoad:V,draggable:!1}),le?t.jsxs(Ur,{style:{left:`${le.left}%`,top:`${le.top}%`,width:`${le.width}%`,height:`${le.height}%`},onPointerDown:Q,children:[t.jsx(Je,{type:"button","aria-label":i({id:l("asset-details.crop.resize.top-left"),defaultMessage:"Resize top-left"}),$cursor:"nwse-resize",style:{left:0,top:0},onPointerDown:ie("tl")}),t.jsx(Je,{type:"button","aria-label":i({id:l("asset-details.crop.resize.top-right"),defaultMessage:"Resize top-right"}),$cursor:"nesw-resize",style:{right:0,top:0},onPointerDown:ie("tr")}),t.jsx(Je,{type:"button","aria-label":i({id:l("asset-details.crop.resize.bottom-left"),defaultMessage:"Resize bottom-left"}),$cursor:"nesw-resize",style:{left:0,bottom:0},onPointerDown:ie("bl")}),t.jsx(Je,{type:"button","aria-label":i({id:l("asset-details.crop.resize.bottom-right"),defaultMessage:"Resize bottom-right"}),$cursor:"nwse-resize",style:{right:0,bottom:0},onPointerDown:ie("br")}),t.jsx(zr,{type:"button","aria-label":i({id:l("asset-details.crop.focal-point"),defaultMessage:"Focal point"}),style:{left:`${L.x}%`,top:`${L.y}%`},onPointerDown:ge})]}):null]}),t.jsxs(Kr,{children:[t.jsxs(S,{direction:"column",alignItems:"stretch",gap:1,paddingBottom:3,children:[t.jsx(R,{variant:"omega",fontWeight:"bold",textColor:g,children:i({id:l("asset-details.crop.title"),defaultMessage:"Crop & Focus area"})}),t.jsx(R,{variant:"pi",textColor:h,children:i({id:l("asset-details.crop.hint"),defaultMessage:"Set the crop area with the rectangle. Pin the always-visible area with the circle."})})]}),t.jsxs(S,{gap:6,alignItems:"center",children:[t.jsxs(S,{alignItems:"center",gap:2,children:[t.jsxs(S,{direction:"column",gap:2,children:[t.jsxs(et,{name:"crop-width",gap:2,children:[t.jsx(xs,{textColor:g,children:t.jsx(fa,{})}),t.jsx(tt,{"aria-label":i({id:l("asset-details.crop.width"),defaultMessage:"Width (px)"}),value:k,min:1,max:C.width||void 0,onValueChange:O=>{O!==void 0&&x({width:O})}})]}),t.jsxs(et,{name:"crop-height",gap:2,children:[t.jsx(xs,{textColor:g,children:t.jsx(ma,{})}),t.jsx(tt,{"aria-label":i({id:l("asset-details.crop.height"),defaultMessage:"Height (px)"}),value:N,min:1,max:C.height||void 0,onValueChange:O=>{O!==void 0&&x({height:O})}})]})]}),t.jsxs(S,{position:"relative",children:[t.jsx(ae,{label:i({id:l("asset-details.crop.aspect-lock"),defaultMessage:"Lock aspect ratio"}),variant:E?"secondary":"ghost",onClick:xe,children:t.jsx(ze,{})}),t.jsx(Wr,{})]})]}),t.jsxs(S,{direction:"column",gap:2,marginLeft:"auto",children:[t.jsxs(et,{name:"focal-x",gap:2,children:[t.jsx(X.Label,{textColor:g,children:i({id:l("asset-details.crop.focal-x-axis"),defaultMessage:"X"})}),t.jsx(tt,{"aria-label":i({id:l("asset-details.crop.focal-x"),defaultMessage:"Focal point X (px)"}),value:We,onValueChange:O=>{O!==void 0&&Le("x",O)}})]}),t.jsxs(et,{name:"focal-y",gap:2,children:[t.jsx(X.Label,{textColor:g,children:i({id:l("asset-details.crop.focal-y-axis"),defaultMessage:"Y"})}),t.jsx(tt,{"aria-label":i({id:l("asset-details.crop.focal-y"),defaultMessage:"Focal point Y (px)"}),value:qe,onValueChange:O=>{O!==void 0&&Le("y",O)}})]})]})]})]})]}),t.jsxs(Vr,{alignItems:"center",children:[t.jsx(G,{variant:"tertiary",onClick:n,disabled:s,children:i({id:"app.components.Button.cancel",defaultMessage:"Cancel"})}),t.jsxs(S,{gap:2,children:[o&&t.jsx(G,{variant:"secondary",onClick:()=>Ge("copy"),loading:s,disabled:!Oe,children:i({id:l("asset-details.crop.save-as-copy"),defaultMessage:"Save as copy"})}),t.jsx(G,{variant:"default",onClick:()=>Ge("apply"),loading:s,disabled:!Oe,children:i({id:l("asset-details.crop.apply"),defaultMessage:"Apply"})})]})]})]})})})},Be=j(_)`
  position: relative;
  width: 100%;
  aspect-ratio: 16 / 9;
  max-height: 24rem;
...
`,eo=j(S)`
  ...
  inset: 0;
  z-index: 1;
`,nt=()=>{const{formatMessage:e}=T();return t.jsx(eo,{justifyContent:"center",alignItems:"center",children:t.jsx(Ce,{children:e({id:"app.loading",defaultMessage:"Loading..."})})})},to=({asset:e,actions:s,isLoading:n=!1})=>{const{formatMessage:a}=T(),{alternativeText:r,ext:o,mime:i,url:d,updatedAt:u,isUrlSigned:f,isLocal:g}=e,h=u&&!f?new Date(u).getTime():void 0,y=x=>!x||h===void 0?x:x.includes("?")?`${x}&v=${h}`:`${x}?v=${h}`,p=y(he(d)),[m,M]=c.useState(!1);c.useEffect(()=>{M(!1)},[p]);const v=c.useRef(null);if(c.useEffect(()=>{const x=v.current;if(!x)return;const D=()=>{const w=x.parentElement;if(!w)return;const k=w.getBoundingClientRect(),N=x.offsetWidth,E=x.offsetHeight;!N||!E||!k.width||k.height};D();const A=new ResizeObserver(D);return A.observe(x),x.parentElement&&A.observe(x.parentElement),()=>A.disconnect()},[m]),i?.includes(ye.Image)){const x=y(he(d));if(x)return t.jsxs(Be,{children:[(!m||n)&&t.jsx(nt,{}),s?t.jsx(Yr,{children:s}):null,t.jsx(st,{children:t.jsx(Gr,{ref:v,src:x,alt:r||e.name||"",crossOrigin:!g&&f?"anonymous":void 0,onLoad:()=>M(!0),onError:()=>M(!0)})})]})}if(i?.includes(ye.Video)&&p)return t.jsxs(Be,{children:[!m&&t.jsx(nt,{}),t.jsx(st,{children:t.jsx(Qr,{src:p,controls:!0,title:e.name,onLoadedData:()=>M(!0),onError:()=>M(!0),children:a({id:l("asset-details.videoNotSupported"),defaultMessage:"Your browser does not support the video tag."})})})]});if(i?.includes(ye.Audio)&&p)return t.jsxs(Be,{children:[!m&&t.jsx(nt,{}),t.jsx(st,{children:t.jsx(S,{width:"100%",padding:4,justifyContent:"center",alignItems:"center",height:"100%",minHeight:"12rem",children:t.jsx(Zr,{src:p,controls:!0,onLoadedData:()=>M(!0),onError:()=>M(!0)})})})]});if((o?.toLowerCase()==="pdf"||o?.toLowerCase()===".pdf"||i==="application/pdf")&&p)return t.jsxs(Be,{children:[!m&&t.jsx(nt,{}),t.jsx(st,{children:t.jsx(Xr,{src:`${p}#toolbar=0`,title:e.name,onLoad:()=>M(!0)})})]});const $=Ke(i,o);return t.jsx(Be,{children:t.jsxs(Jr,{justifyContent:"center",alignItems:"center",gap:1,direction:"column",hasRadius:!0,children:[t.jsx($,{width:24,height:24}),t.jsx(R,{variant:"pi",children:a({id:l("asset-details.noPreview"),defaultMessage:"No preview available"})})]})})},jn=c.createContext(null),wn=()=>{const e=c.useContext(jn);if(!e)throw new Error("useDrawerNotify must be used within AssetDetails");return e},Mn=c.createContext(null),Cn=()=>{const e=c.useContext(Mn);if(!e)throw new Error("useAssetOperation must be used within AssetDetails");return e},vn=()=>{const[{query:e},s]=Ie(),n=yn(e?.[at]),a=n!==null,[r,o]=c.useState(a),i=c.useRef(null);c.useEffect(()=>{a&&(i.current=n,o(!0))},[a,n]);const d=c.useCallback(g=>{g.target===g.currentTarget&&!a&&o(!1)},[a]),u=c.useCallback(g=>{s({[at]:String(g)},"push",!0)},[s]),f=c.useCallback(()=>{s({[at]:void 0},"remove",!0)},[s]);return{assetId:a?n:i.current,isVisible:a,shouldRenderDrawer:r,onCloseAnimationEnd:d,openDetails:u,closeDetails:f}},so=j(S)`
...
`,Ko=({items:e})=>{const{formatMessage:s}=T();if(e.length===0)return null;if(e.length===1){const o=e[0],i=o.kind==="folder",d=i?ve:rt,u=i?St:It;return t.jsxs(En,{children:[t.jsx(Dt,{children:t.jsx(d,{width:u,height:u})}),t.jsx(R,{textColor:"neutral800",fontWeight:"semiBold",ellipsis:!0,children:o.name})]})}const n=e.filter(o=>o.kind==="folder").length,a=e.filter(o=>o.kind==="file").length,r=n+a;return t.jsxs(Uo,{gap:3,children:[n>0?t.jsxs(Ms,{children:[t.jsx(Dt,{children:t.jsx(ve,{width:St,height:St})}),t.jsx(R,{textColor:"neutral800",fontWeight:"semiBold",children:s({id:l("dnd.overlay.folders"),defaultMessage:"{count, plural, one {# folder} other {# folders}}"},{count:n})})]}):null,a>0?t.jsxs(Ms,{children:[t.jsx(Dt,{children:t.jsx(rt,{width:It,height:It})}),t.jsx(R,{textColor:"neutral800",fontWeight:"semiBold",children:s({id:l("dnd.overlay.files"),defaultMessage:"{count, plural, one {# file} other {# files}}"},{count:a})})]}):null,t.jsx(zo,{children:t.jsx(R,{textColor:"neutral0",fontWeight:"bold",variant:"pi",children:r})})]})},Tn=c.createContext(null),ue=()=>c.useContext(Tn),Cs=e=>{const s=Bo(e);if(s!=null)return{destinationFolderId:s};const n=_o(e);return n==="root"?{destinationFolderId:null}:typeof n=="number"?{destinationFolderId:n}:null},Vo=Number.MAX_SAFE_INTEGER,Ho=({children:e,locations:s=hn})=>{const{formatMessage:n}=T(),a=xt(),{toggleNotification:r}=fe(),o=So(),{currentFolderId:i}=He(),{data:d=[]}=Jt(),u=n({id:l("plugin.name"),defaultMessage:"Media Library"}),[f,{isLoading:g}]=pn(),[h,y]=c.useState([]),[p,m]=c.useState(""),M=c.useRef({items:[],fromSelection:!1,activeSourceFolderId:null,spansMultipleSources:!1}),v=c.useCallback(L=>{m(""),requestAnimationFrame(()=>m(L))},[]),{canUpdate:C}=ce(),$=or(ir(ur,{activationConstraint:{distance:C?8:Vo}})),x=c.useMemo(()=>To(h,d),[h,d]),D=c.useCallback(L=>x.has(L),[x]),A=c.useMemo(()=>({isInternalDragActive:h.length>0,isMovePending:g,isValidDropTarget:D}),[h.length,g,D]),w=c.useCallback(()=>{M.current={items:[],fromSelection:!1,activeSourceFolderId:null,spansMultipleSources:!1},y([])},[]),k=c.useCallback(L=>{const b=L.active.data.current;if(!b){w();return}const I=js(b,o?.selectedKeys,s,i);M.current=I,y(I.items)},[w,i,s,o?.selectedKeys]),N=c.useCallback(async L=>{const{over:b}=L,{items:I,fromSelection:F,activeSourceFolderId:U,spansMultipleSources:V}=M.current;if(w(),g||!b||I.length===0)return;const H=Cs(b.id);if(!H)return;const{destinationFolderId:P}=H;if(!Ee({items:I,targetFolderId:P,folderStructure:d}))return;const q=Eo(I),Q=$n({formatMessage:n,count:I.length,source:V?null:bs(d,U,u),destination:bs(d,P,u)}),ie=n({id:l("list.bulk-actions.move.error"),defaultMessage:"An error occurred while moving the items."});try{await f({...q,destinationFolderId:P}).unwrap(),F&&o?.clear(),v(Q),r({type:"success",message:Q})}catch(xe){const ge=a(xe,ie);v(n({id:l("dnd.announce.move-failure"),defaultMessage:"Move failed. {message}"},{message:ge})),r({type:"danger",message:ge})}},[v,f,w,d,n,a,g,u,o,r]),E=c.useCallback(()=>{w()},[w]),Y=c.useMemo(()=>({onDragStart:({active:L})=>{const b=L.data.current;return b?n({id:l("dnd.announce.drag-start"),defaultMessage:"Picked up {name}. Drop on a folder to move."},{name:b.name}):""},onDragOver:()=>"",onDragEnd:({active:L,over:b})=>{if(!b)return n({id:l("dnd.announce.cancel"),defaultMessage:"Drag cancelled."});const I=Cs(b.id),F=L.data.current;if(!I||!F)return"";const{items:U}=js(F,o?.selectedKeys,s,i);return Ee({items:U,targetFolderId:I.destinationFolderId,folderStructure:d})?"":n({id:l("dnd.announce.invalid-drop"),defaultMessage:"Cannot move item to this folder."})},onDragCancel:()=>n({id:l("dnd.announce.cancel"),defaultMessage:"Drag cancelled."})}),[i,d,n,s,o?.selectedKeys]);return t.jsx(Tn.Provider,{value:A,children:t.jsxs(lr,{sensors:$,collisionDetection:dr,onDragStart:k,onDragEnd:N,onDragCancel:E,accessibility:{announcements:Y},children:[t.jsx(De,{"aria-live":"polite","aria-atomic":"true",children:p}),t.jsx(S,{position:"relative",alignItems:"stretch",direction:"column",height:"100%",children:e}),t.jsx(cr,{dropAnimation:null,children:h.length>0?t.jsx(Ko,{items:h}):null})]})})},Ln=e=>{const{isMovePending:s}=ue()??{isMovePending:!1},n=c.useMemo(()=>({kind:"file",id:e.id,name:e.name,folderId:it(e.folder)}),[e.folder,e.id,e.name]);return{...cn({id:Lo(e.id),data:n,disabled:s}),dragData:n}},On=e=>{const{isMovePending:s,isValidDropTarget:n}=ue()??{isMovePending:!1,isValidDropTarget:()=>!1},{active:a}=dn(),r=it(e.parent),o=c.useMemo(()=>({kind:"folder",id:e.id,name:e.name,parentId:r}),[e.id,e.name,r]),i=c.useMemo(()=>({kind:"folder-target",id:e.id,name:e.name}),[e.id,e.name]),d=cn({id:Oo(e.id),data:o,disabled:s}),u=un({id:Po(e.id),data:i,disabled:s}),f=n(e.id),g=u.isOver,h=g&&f,y=g&&!f&&a!=null;return{dragData:o,draggable:d,droppable:u,isDragging:d.isDragging,showValidDropHighlight:h,showInvalidDropCursor:y}},Wo=j(Z.Content)`
  max-width: 51.6rem;
`,Pn=e=>{const{open:s,parentFolderId:n,onClose:a,mode:r}=e,o=e.mode==="rename"?e.initialName:"",{formatMessage:i}=T(),{toggleNotification:d}=fe(),{trackUsage:u}=$e(),[f,g]=c.useState(o),[h,y]=c.useState(),p=c.useRef(null),[m,{isLoading:M}]=jr(),[v,{isLoading:C}]=wr(),$=r==="rename"?C:M;c.useEffect(()=>{s&&(g(o),y(void 0),r==="rename"&&p.current?.select())},[s,o,r]);const x=async D=>{D.preventDefault();const A=f.trim();if(!A){y(i({id:l("folder.create.form.error.name-required"),defaultMessage:"Name is required"}));return}try{e.mode==="rename"?(await v({id:e.folderId,name:A,parent:n}).unwrap(),u("didEditMediaLibraryElements",{location:ee,type:"folder",changeLocation:!1})):(await m({name:A,parent:n}).unwrap(),u("didAddMediaLibraryFolders",{location:ee})),d({type:"success",message:i(r==="rename"?{id:l("folder.rename.success"),defaultMessage:"Folder has been renamed"}:{id:l("folder.create.success"),defaultMessage:"Folder has been created"})}),a()}catch(w){const k=w;k?.message?y(k.message):d({type:"danger",message:i(r==="rename"?{id:l("folder.rename.form.error.unknown"),defaultMessage:"An error occurred while renaming the folder"}:{id:l("folder.create.form.error.unknown"),defaultMessage:"An error occurred while creating the folder"})})}};return t.jsx(Z.Root,{open:s,onOpenChange:a,children:t.jsxs(Wo,{children:[t.jsx(Z.Header,{children:t.jsx(Z.Title,{children:e.mode==="rename"?i({id:l("folder.rename.title"),defaultMessage:"Rename folder"}):i({id:l("folder.create.title-in"),defaultMessage:"New folder in {folderName}"},{folderName:e.parentFolderName})})}),t.jsxs("form",{onSubmit:x,children:[t.jsx(Z.Body,{children:t.jsxs(X.Root,{error:h,name:"name",required:!0,children:[t.jsx(X.Label,{children:i({id:l("folder.form.name.label"),defaultMessage:"Folder name"})}),t.jsx(en,{ref:p,value:f,onChange:D=>{g(D.target.value),y(void 0)},autoFocus:!0}),t.jsx(X.Error,{})]})}),t.jsx(Z.Footer,{children:t.jsxs(S,{gap:2,justifyContent:"space-between",width:"100%",children:[t.jsx(G,{variant:"tertiary",onClick:a,type:"button",children:i({id:"app.components.Button.cancel",defaultMessage:"Cancel"})}),t.jsx(G,{type:"submit",loading:$,disabled:r==="rename"&&f.trim()===o.trim(),children:i(r==="rename"?{id:l("folder.rename.submit"),defaultMessage:"Save"}:{id:l("folder.create.submit"),defaultMessage:"Create folder"})})]})})]})]})})},Bn=({folder:e,dragData:s})=>{const{formatMessage:n}=T(),{copy:a}=qt(),{toggleNotification:r}=fe(),{deselect:o}=me(),[i,d]=c.useState(!1),[u,f]=c.useState(!1),[g,h]=c.useState(!1),y=c.useMemo(()=>[s],[s]),p=async()=>{const m=`${window.location.origin}${window.location.pathname}?folder=${e.id}`,M=await a(m);r({type:M?"success":"danger",message:n(M?{id:l("list.folder.actions.copy-link.success"),defaultMessage:"Folder link copied."}:{id:l("list.folder.actions.copy-link.error"),defaultMessage:"Failed to copy the folder link."})})};return t.jsxs(t.Fragment,{children:[t.jsxs(B.Root,{modal:!1,children:[t.jsx(B.Trigger,{tag:ae,icon:t.jsx(an,{}),variant:"ghost",label:n({id:l("control-card.more-actions"),defaultMessage:"More actions"})}),t.jsxs(Dn,{popoverPlacement:"bottom-end",zIndex:2,minWidth:"22rem",children:[t.jsx(B.Item,{startIcon:t.jsx(ze,{}),onSelect:p,children:n({id:l("list.folder.actions.copy-link"),defaultMessage:"Copy link to folder"})}),t.jsx(B.Separator,{}),t.jsx(B.Item,{startIcon:t.jsx(Ca,{}),onSelect:()=>d(!0),children:n({id:l("list.folder.actions.rename"),defaultMessage:"Rename folder"})}),t.jsx(B.Item,{startIcon:t.jsx(Gt,{}),onSelect:()=>f(!0),children:n({id:l("list.folder.actions.move"),defaultMessage:"Move to folder"})}),t.jsx(B.Item,{startIcon:t.jsx(ut,{}),variant:"danger",onSelect:()=>h(!0),children:n({id:l("list.folder.actions.delete"),defaultMessage:"Delete folder"})})]})]}),i&&t.jsx(Pn,{open:!0,mode:"rename",folderId:e.id,initialName:e.name,parentFolderId:s.parentId,onClose:()=>d(!1)}),u&&t.jsx(as,{open:!0,onClose:()=>f(!1),items:y,onSuccess:()=>o(je(e.id))}),g&&t.jsx(rs,{open:!0,onClose:()=>h(!1),target:{fileIds:[],folderIds:[e.id]},onSuccess:()=>o(je(e.id))})]})},Re=e=>{te(e)&&e.stopPropagation()},qo=j(S)`
  position: absolute;
  top: ${({theme:e})=>e.spaces[3]};
...
`,Xo=j(Ve)`
  flex: 1;
  min-width: 0;
`,Jo=({folder:e,orderedItemKeys:s})=>{const{formatMessage:n}=T(),{navigateToFolder:a}=He(),{isMovePending:r}=ue()??{isMovePending:!1},{isSelected:o,toggle:i,selectRange:d}=me(),{canUpdate:u}=ce(),{dragData:f,draggable:{attributes:g,listeners:h,setNodeRef:y,isDragging:p},droppable:{setNodeRef:m},showValidDropHighlight:M,showInvalidDropCursor:v}=On(e),C=je(e.id),$=w=>{y(w),m(w)},x=w=>{te(w)&&(w.shiftKey?d(s,C):w.metaKey||w.ctrlKey?i(C):a(e))},D=w=>{te(w)&&(w.key==="Enter"?(w.preventDefault(),a(e)):w.key===" "&&(w.preventDefault(),i(C)))},A=w=>{w.stopPropagation(),w.shiftKey?d(s,C):i(C)};return t.jsxs(Qo,{ref:$,...g,...h,$isDragging:p,$isMovePending:r,$isValidDropTarget:M,$isInvalidDropTarget:v,$isSelected:o(C),onClick:x,onKeyDown:D,onPointerDown:w=>{te(w)&&h?.onPointerDown?.(w)},role:"listitem",tabIndex:0,children:[u&&t.jsx(S,{onKeyDown:w=>w.stopPropagation(),children:t.jsx(ke,{checked:o(C),onClick:A,"aria-label":n({id:l("list.table.row.select"),defaultMessage:"Select {name}"},{name:e.name})})}),t.jsx(Zo,{children:t.jsx(ve,{width:20,height:20})}),t.jsx(Xo,{textColor:"neutral800",children:e.name}),t.jsx(S,{onClick:Re,onKeyDown:Re,onPointerDown:Re,children:t.jsx(Bn,{folder:e,dragData:f})})]})},vs=j(_)`
  position: relative;
  width: 100%;
  padding-bottom: 62.5%;
  height: 0;
...
`,li=({asset:e,orderedItemKeys:s,onAssetItemClick:n})=>{const{formatMessage:a}=T(),r=Ke(e.mime,e.ext),{isMovePending:o}=ue()??{isMovePending:!1},{attributes:i,listeners:d,setNodeRef:u,isDragging:f,dragData:g}=Ln(e),{isSelected:h,toggle:y,selectRange:p}=me(),{canUpdate:m}=ce(),M=ss()?.getBusyMessage(e.id)??null,v=be(e.id),C=h(v),$=w=>{te(w)&&(w.shiftKey?p(s,v):w.metaKey||w.ctrlKey?y(v):n(e.id))},x=w=>{te(w)&&(w.key==="Enter"?(w.preventDefault(),n(e.id)):w.key===" "&&(w.preventDefault(),y(v)))},D=w=>{w.stopPropagation(),n(e.id)},A=w=>{w.stopPropagation(),w.shiftKey?p(s,v):y(v)};return t.jsxs(Go,{ref:u,...i,...d,$isDragging:f,$isMovePending:o,$isBusy:M!==null,$isSelected:C,tabIndex:0,role:"listitem",onDragStart:w=>w.preventDefault(),onClick:$,onKeyDown:x,onPointerDown:w=>{te(w)&&d?.onPointerDown?.(w)},children:[t.jsxs(ni,{children:[m&&t.jsx(qo,{onKeyDown:w=>w.stopPropagation(),children:t.jsx(ke,{checked:C,onClick:A,"aria-label":a({id:l("list.table.row.select"),defaultMessage:"Select {name}"},{name:e.name})})}),t.jsx(si,{asset:e}),M!==null?t.jsx(bn,{zIndex:2,children:M}):null]}),t.jsx(va,{children:t.jsxs(ai,{alignItems:"center",gap:2,children:[t.jsx(ri,{children:t.jsx(r,{width:20,height:20})}),t.jsx(ii,{type:"button",onClick:D,children:t.jsx(oi,{textColor:"primary800",children:e.name})}),t.jsx(S,{onClick:Re,onKeyDown:Re,onPointerDown:Re,children:t.jsx(Fn,{asset:e,dragData:g})})]})})]})},di=({assets:e,folders:s=[],onAssetItemClick:n})=>{const a=s.length+e.length,r=[...s.map(o=>je(o.id)),...e.map(o=>be(o.id))];return a===0?null:t.jsxs(Ze.Root,{gap:4,role:"list","data-testid":"assets-grid",children:[s.length>0&&t.jsx(Yo,{children:t.jsx(Ze.Root,{gap:4,children:s.map(o=>t.jsx(Ze.Item,{col:3,m:4,s:6,xs:12,children:t.jsx(Jo,{folder:o,orderedItemKeys:r})},`folder-${o.id}`))})}),e.map(o=>t.jsx(Ze.Item,{col:3,m:4,s:6,xs:12,direction:"column",alignItems:"stretch",children:t.jsx(li,{asset:o,orderedItemKeys:r,onAssetItemClick:n})},o.id))]})},Nn=()=>{const[{query:e},s]=Ie(),n=e?._q??"",a=c.useCallback(o=>{o?s({_q:Zt(o)},"push",!0):s({_q:""},"remove",!0)},[s]),r=c.useCallback(()=>a(""),[a]);return{searchQuery:n,isSearching:n!=="",setSearchQuery:a,clearSearch:r}},ci=300,ui=j($a)`
  > div {
    border: none;
  }
`,gi=()=>{const{formatMessage:e}=T(),{searchQuery:s,setSearchQuery:n}=Nn(),{trackUsage:a}=$e(),r=rn(),[o,i]=c.useState(s),d=Da(o,ci),u=c.useRef(s),[{query:f}]=Ie(),g=f?.folder??"",h=c.useRef(g);c.useEffect(()=>{d!==u.current&&(u.current=d,d&&a("didSearchMediaLibraryElements",{location:ee}),n(d))},[d,n,a]),c.useEffect(()=>{s!==u.current&&(u.current=s,i(s))},[s]),c.useEffect(()=>{g!==h.current&&(h.current=g,u.current=s,i(s))},[g,s]);const y=t.jsx(ui,{onSubmit:p=>p.preventDefault(),children:t.jsx(ka,{name:"search-assets",value:o,onChange:p=>i(p.target.value),onClear:()=>i(""),clearLabel:e({id:"clearLabel",defaultMessage:"Clear"}),placeholder:e({id:l("header.search.placeholder"),defaultMessage:"Search"}),size:"S",children:e({id:l("search.label"),defaultMessage:"Search for an asset"})})});return r?t.jsx(_,{width:"100%",children:y}):y},pi={view:"STRAPI_UPLOAD_LIBRARY_VIEW"},Ne={GRID:0,TABLE:1},Ss=[{name:"name",label:{id:l("list.table.header.name"),defaultMessage:"name"}},{name:"createdAt",label:{id:l("list.table.header.creationDate"),defaultMessage:"creation date"}},{name:"updatedAt",label:{id:l("list.table.header.lastModified"),defaultMessage:"last modified"}},{name:"size",label:{id:l("list.table.header.size"),defaultMessage:"size"}},{name:"actions",label:{id:l("list.table.header.actions"),defaultMessage:"actions"},isVisuallyHidden:!0}],hi=j(Ra)`
  width: 100%;
...
`,de=e=>{te(e)&&e.stopPropagation()},bi=({asset:e})=>{const{ext:s,mime:n}=e,a=Ke(n,s);return t.jsx(S,{justifyContent:"center",alignItems:"center",borderRadius:"4px",color:"neutral500",width:"3.2rem",height:"3.2rem",shrink:0,children:t.jsx(a,{width:20,height:20})})},Is=({asset:e,orderedItemKeys:s,onAssetItemClick:n})=>{const a=Yt(),{formatDate:r,formatMessage:o}=T(),{isMovePending:i}=ue()??{isMovePending:!1},{attributes:d,listeners:u,setNodeRef:f,isDragging:g,dragData:h}=Ln(e),{isSelected:y,toggle:p,selectRange:m}=me(),{canUpdate:M}=ce(),v=ss()?.getBusyMessage(e.id)??null,C=be(e.id),$=y(C),x=!e.caption||!e.alternativeText,D=o({id:l("list.table.row.metadata-missing"),defaultMessage:"This asset is missing metadata (caption or alternative text)."}),A=E=>{te(E)&&(E.shiftKey?m(s,C):E.metaKey||E.ctrlKey?p(C):n(e.id))},w=E=>{te(E)&&(E.key==="Enter"?(E.preventDefault(),n(e.id)):E.key===" "&&(E.preventDefault(),p(C)))},k=E=>{E.stopPropagation(),n(e.id)},N=E=>{E.stopPropagation(),E.shiftKey?m(s,C):p(C)};return t.jsxs(_n,{ref:f,...d,...u,$isDragging:g,$isMovePending:i,$isBusy:v!==null,$isSelected:$,tabIndex:0,role:"row",onDragStart:E=>E.preventDefault(),onClick:A,onKeyDown:w,onPointerDown:E=>{te(E)&&u?.onPointerDown?.(E)},children:[M&&t.jsx(Un,{onClick:de,onKeyDown:de,children:t.jsx(S,{children:t.jsx(ke,{checked:$,onClick:N,"aria-label":o({id:l("list.table.row.select"),defaultMessage:"Select {name}"},{name:e.name})})})}),t.jsx(oe,{children:t.jsxs(S,{alignItems:"center",justifyContent:"space-between",gap:2,minWidth:0,children:[t.jsxs(S,{gap:3,alignItems:"center",minWidth:0,children:[v!==null?t.jsx(S,{justifyContent:"center",width:"3.2rem",height:"3.2rem",children:t.jsx(Ce,{small:!0,children:v})}):t.jsx(bi,{asset:e}),t.jsxs(S,{direction:"column",alignItems:"flex-start",minWidth:0,children:[t.jsx(yi,{type:"button",onClick:k,children:t.jsx(Ve,{textColor:"neutral800",fontWeight:"semiBold",children:e.name})}),!a&&t.jsx(R,{textColor:"neutral600",variant:"pi",children:e.size?Pt(e.size,1):"-"})]})]}),x&&t.jsx(ct,{label:D,children:t.jsx(xi,{"aria-label":D,role:"img"})})]})}),a&&t.jsxs(t.Fragment,{children:[t.jsx(oe,{children:t.jsx(R,{textColor:"neutral600",children:e.createdAt?r(new Date(e.createdAt),{dateStyle:"long"}):"-"})}),t.jsx(oe,{children:t.jsx(R,{textColor:"neutral600",children:e.updatedAt?r(new Date(e.updatedAt),{dateStyle:"long"}):"-"})}),t.jsx(oe,{children:t.jsx(R,{textColor:"neutral600",children:e.size?Pt(e.size,1):"-"})})]}),t.jsx(oe,{onClick:de,onKeyDown:de,onPointerDown:de,children:t.jsx(S,{justifyContent:"flex-end",children:t.jsx(Fn,{asset:e,dragData:h})})})]})},ji=j(_n)`
  &:hover {
    background: ${({theme:e})=>e.colors.primary100};
  }
`,Ds=({folder:e,orderedItemKeys:s})=>{const n=Yt(),{formatDate:a,formatMessage:r}=T(),{navigateToFolder:o}=He(),{isSelected:i,toggle:d,selectRange:u}=me(),{canUpdate:f}=ce(),{isMovePending:g}=ue()??{isMovePending:!1},{dragData:h,draggable:{attributes:y,listeners:p,setNodeRef:m,isDragging:M},droppable:{setNodeRef:v},showValidDropHighlight:C,showInvalidDropCursor:$}=On(e),x=je(e.id),D=k=>{te(k)&&(k.shiftKey?u(s,x):k.metaKey||k.ctrlKey?d(x):o(e))},A=k=>{te(k)&&(k.key==="Enter"?(k.preventDefault(),o(e)):k.key===" "&&(k.preventDefault(),d(x)))},w=k=>{k.stopPropagation(),k.shiftKey?u(s,x):d(x)};return t.jsxs(ji,{ref:k=>{m(k),v(k)},...y,...p,$isDragging:M,$isMovePending:g,$isValidDropTarget:C,$isInvalidDropTarget:$,$isSelected:i(x),tabIndex:0,role:"row",onDragStart:k=>{te(k)&&k.preventDefault()},onClick:D,onKeyDown:A,onPointerDown:k=>{te(k)&&p?.onPointerDown?.(k)},children:[f&&t.jsx(Un,{onClick:de,onKeyDown:de,children:t.jsx(S,{children:t.jsx(ke,{checked:i(x),onClick:w,"aria-label":r({id:l("list.table.row.select"),defaultMessage:"Select {name}"},{name:e.name})})})}),t.jsx(oe,{children:t.jsxs(S,{gap:3,alignItems:"center",minWidth:0,children:[t.jsx(S,{justifyContent:"center",alignItems:"center",borderRadius:"4px",color:"neutral600",width:"3.2rem",height:"3.2rem",shrink:0,children:t.jsx(ve,{width:20,height:20})}),t.jsx(Ve,{textColor:"neutral800",fontWeight:"semiBold",children:e.name})]})}),n&&t.jsxs(t.Fragment,{children:[t.jsx(oe,{children:t.jsx(R,{textColor:"neutral600",children:e.createdAt?a(new Date(e.createdAt),{dateStyle:"long"}):"-"})}),t.jsx(oe,{children:t.jsx(R,{textColor:"neutral600",children:e.updatedAt?a(new Date(e.updatedAt),{dateStyle:"long"}):"-"})}),t.jsx(oe,{children:t.jsx(R,{textColor:"neutral600",children:"-"})})]}),t.jsx(oe,{onClick:de,onKeyDown:de,onPointerDown:de,children:t.jsx(S,{justifyContent:"flex-end",children:t.jsx(Bn,{folder:e,dragData:h})})})]})},wi=({assets:e,folders:s=[],mixedItems:n=null,onAssetItemClick:a})=>{const r=Yt(),{formatMessage:o}=T(),{selectedKeys:i,selectAll:d,clear:u}=me(),{canUpdate:f}=ce(),{trackUsage:g}=$e(),h=r?Ss:Ss.filter(x=>x.name==="name"||x.name==="actions"),y=f,p=h.length+(y?1:0),m=s.length+e.length,M=n?n.map(x=>x.kind==="folder"?je(x.folder.id):be(x.asset.id)):[...s.map(x=>je(x.id)),...e.map(x=>be(x.id))],{allSelected:v,isIndeterminate:C}=Co(i,M),$=()=>{v?u():(g("didSelectAllMediaLibraryElements"),d(M))};return m===0?null:t.jsxs(hi,{colCount:p,rowCount:(n?n.length:m)+1,children:[t.jsx(fi,{children:t.jsxs(Aa,{children:[y&&t.jsx(mi,{children:t.jsx(S,{children:t.jsx(ke,{checked:C?"indeterminate":v,disabled:M.length===0,onCheckedChange:$,"aria-label":o({id:l("list.table.header.select-all"),defaultMessage:"Select all"})})})}),h.map(x=>{const D=o(x.label);return"isVisuallyHidden"in x&&x.isVisuallyHidden?t.jsx(Bt,{children:t.jsx(De,{children:o({id:l("table.header.actions"),defaultMessage:"actions"})})},x.name):t.jsx(Bt,{children:t.jsx(R,{textColor:"neutral600",variant:"sigma",children:D})},x.name)})]})}),t.jsxs(Fa,{children:[n?.map(x=>x.kind==="folder"?t.jsx(Ds,{folder:x.folder,orderedItemKeys:M},`folder-${x.folder.id}`):t.jsx(Is,{asset:x.asset,orderedItemKeys:M,onAssetItemClick:a},x.asset.id)),!n&&s.map(x=>t.jsx(Ds,{folder:x,orderedItemKeys:M},`folder-${x.id}`)),!n&&e.map(x=>t.jsx(Is,{asset:x,orderedItemKeys:M,onAssetItemClick:a},x.id))]})]})},Mi=(e,s,n,a)=>{const r=[];return e.forEach(o=>{r.push({kind:"file",id:o,name:"",folderId:lt(n,"file",o,a)})}),s.forEach(o=>{r.push({kind:"folder",id:o,name:"",parentId:lt(n,"folder",o,a)})}),r},Ci=j(S)`
  position: fixed;
...
`,Ii=({assets:e=[],locations:s=hn})=>{const{formatMessage:n}=T(),{toggleNotification:a}=fe(),r=mt(),{canUpdate:o}=ce(),{selectedIds:i,selectedFolderIds:d,clear:u}=me(),{currentFolderId:f}=He(),g=Rr(),[h,{isLoading:y}]=Oa(),[p,m]=c.useState(!1),[M,v]=c.useState(!1),[C,$]=c.useState(!1),x=i.size+d.size,D=C||y,A=c.useMemo(()=>Mi(i,d,s,f),[i,d,s,f]),w=i.size>fs,k=c.useMemo(()=>{const L=new Map(e.map(({id:b,mime:I})=>[b,I]));return[...i].filter(b=>gn(L.get(b))).length},[e,i]),N=i.size>0&&k===0;let E;w?E=n({id:l("list.bulk-actions.create-metadata.too-many"),defaultMessage:"Metadata can be generated for up to {max} assets at a time. Select fewer assets to continue."},{max:fs}):N&&(E=n({id:l("list.bulk-actions.create-metadata.no-eligible"),defaultMessage:"Metadata can only be generated for images. None of the selected assets are supported."}));const Y=async()=>{if(y||w||N)return;const L=Array.from(i),b=await h({fileIds:L});if("error"in b){a({type:"danger",message:n({id:l("list.bulk-actions.create-metadata.error"),defaultMessage:"An error occurred while generating metadata."})});return}const I=b.data.filter(({status:H})=>H==="success").length,F=b.data.filter(({status:H})=>H==="skipped").length,U=b.data.filter(({status:H})=>H==="error").length,V=d.size;if(U===b.data.length){a({type:"danger",message:n({id:l("list.bulk-actions.create-metadata.error"),defaultMessage:"An error occurred while generating metadata."})});return}a(F===0&&U===0&&V===0?{type:"success",message:n({id:l("list.bulk-actions.create-metadata.success"),defaultMessage:"{count, plural, =1 {Metadata generated for # asset} other {Metadata generated for # assets}}"},{count:I})}:{type:"warning",message:n({id:l("list.bulk-actions.create-metadata.partial"),defaultMessage:"{successCount} generated, {skippedCount} skipped (unsupported file type), {errorCount} failed{folderCount, plural, =0 {} one {, # folder ignored} other {, # folders ignored}}"},{successCount:I,skippedCount:F,errorCount:U,folderCount:V})}),u()};return x===0||!o||g?null:t.jsxs(Ci,{tag:"section",role:"region","aria-label":n({id:l("list.bulk-actions.label"),defaultMessage:"Bulk actions"}),children:[t.jsx(R,{fontWeight:"bold",textColor:"neutral800",marginRight:4,children:n({id:l("list.bulk-actions.selected-count"),defaultMessage:"{count, plural, =1 {# item selected} other {# items selected}}"},{count:x})}),t.jsxs(vi,{children:[r&&t.jsx(ct,{label:E,children:t.jsx(_,{children:t.jsx(G,{size:"S",startIcon:t.jsx(Pa,{}),disabled:D||i.size===0||w||N,loading:y,onClick:Y,children:n({id:l("list.bulk-actions.create-metadata"),defaultMessage:"Create metadata"})})})}),t.jsx(ae,{variant:"tertiary",disabled:D,label:n({id:l("list.bulk-actions.move"),defaultMessage:"Move"}),onClick:()=>v(!0),children:t.jsx(Gt,{})}),t.jsx(as,{open:M,onClose:()=>v(!1),items:A,onSuccess:u}),t.jsx(ae,{variant:"danger-light",disabled:D,label:n({id:l("list.bulk-actions.delete"),defaultMessage:"Delete"}),onClick:()=>m(!0),children:t.jsx(ut,{})}),t.jsx(rs,{open:p,onClose:()=>m(!1),target:{fileIds:Array.from(i),folderIds:Array.from(d)},onSuccess:u,onPendingChange:$})]}),t.jsx(Si,{"aria-hidden":!0}),t.jsx(ae,{variant:"ghost",label:n({id:l("list.bulk-actions.clear"),defaultMessage:"Clear selection"}),onClick:u,disabled:D,children:t.jsx(pt,{})})]})},zn=c.createContext(null),Di=j(_)`
  position: relative;
  display: flex;
  flex-direction: column;
  min-height: 100%;
`,ki=({children:e,onDrop:s,disabled:n=!1})=>{const[a,r]=c.useState(!1),o=c.useRef(0),i={isDragging:a};c.useEffect(()=>{const h=()=>{r(!1),o.current=0},y=p=>{p.relatedTarget||(r(!1),o.current=0)};return document.addEventListener("dragend",h),document.addEventListener("dragleave",y),()=>{document.removeEventListener("dragend",h),document.removeEventListener("dragleave",y)}},[]);const d=c.useCallback(h=>{h.preventDefault(),h.stopPropagation(),!n&&h.dataTransfer.types.includes("Files")&&(o.current+=1,r(!0))},[n]),u=c.useCallback(h=>{h.preventDefault(),h.stopPropagation(),o.current-=1,o.current<=0&&(r(!1),o.current=0)},[]),f=c.useCallback(h=>{h.preventDefault(),h.stopPropagation(),h.dataTransfer.dropEffect="copy"},[]),g=c.useCallback(h=>{if(h.preventDefault(),h.stopPropagation(),r(!1),o.current=0,n)return;const{files:y}=h.dataTransfer;y?.length&&s&&s(Array.from(y))},[s,n]);return t.jsx(zn.Provider,{value:i,children:t.jsx(Di,{"data-testid":"assets-dropzone",onDragEnter:d,onDragLeave:u,onDragOver:f,onDrop:g,children:e})})},Kn=()=>{const e=c.useContext(zn);if(!e)throw new Error("useUploadDropZone must be used within UploadDropZone");return{isDragging:e.isDragging}},$i=(e,s)=>`${e}${Math.floor(s*255).toString(16).padStart(2,"0")}`,Ai=j(_)`
  position: absolute;
  top: 0;
  left: 0;
  right: 0;
...
`,Fi=({children:e})=>{const{isDragging:s}=Kn(),a=ue()?.isInternalDragActive??!1,r=s&&!a;return t.jsxs(_,{position:"relative",children:[r&&t.jsx(Ai,{}),e]})},Ri=j(_)`
  ...
  border-radius: ${({theme:e})=>e.borderRadius};
  z-index: 2;
`,Ei=({uploadDropZoneRef:e,folderName:s})=>{const{formatMessage:n}=T(),{isDragging:a}=Kn(),o=ue()?.isInternalDragActive??!1,i=a&&!o,[d,u]=c.useState(0);return c.useEffect(()=>{if(!e?.current)return;const f=()=>{const h=e.current?.getBoundingClientRect();h&&u(y=>y!==h.left?h.left:y)};f();const g=new ResizeObserver(f);return g.observe(e.current),()=>g.disconnect()},[e]),i?t.jsxs(Ri,{$leftContentWidth:d,children:[t.jsx(R,{textColor:"neutral0",children:n({id:l("dropzone.upload.message"),defaultMessage:"Drop here to upload to"})}),t.jsxs(S,{gap:2,alignItems:"center",children:[t.jsx(ve,{width:20,height:20,fill:"neutral0"}),t.jsx(R,{textColor:"neutral0",fontWeight:"semiBold",children:s})]})]}):null},Ti=({onAddAssets:e,canAddAssets:s,searchQuery:n,onClearSearch:a})=>{const{formatMessage:r}=T(),o=!!n;return t.jsxs(S,{direction:"column",alignItems:"center",gap:6,padding:11,children:[t.jsx(on,{width:"16rem",height:"8.8rem"}),t.jsxs(S,{direction:"column",alignItems:"center",gap:2,textAlign:"center",children:[t.jsx(R,{variant:"delta",tag:"p",fontWeight:"bold",textColor:"neutral800",children:r(o?{id:l("list.search.empty.title"),defaultMessage:"No results found"}:{id:l("list.empty.title"),defaultMessage:"No assets yet"})}),t.jsx(R,{textColor:"neutral600",children:o?r({id:l("list.search.empty.description"),defaultMessage:'No assets or folders match "{query}". Try a different search.'},{query:n}):r({id:l("list.empty.description"),defaultMessage:"Get started by uploading assets or creating a folder."})})]}),o?t.jsx(G,{variant:"secondary",startIcon:t.jsx(pt,{"aria-hidden":!0}),onClick:a,children:r({id:l("list.search.empty.clear"),defaultMessage:"Clear search"})}):s&&t.jsx(G,{onClick:e,children:r({id:l("list.empty.add-assets"),defaultMessage:"Add assets"})})]})},Li=({onClearFilters:e})=>{const{formatMessage:s}=T();return t.jsxs(S,{direction:"column",alignItems:"center",gap:6,padding:11,children:[t.jsx(on,{width:"16rem",height:"8.8rem"}),t.jsx(R,{textColor:"neutral600",children:s({id:l("list.filters.empty"),defaultMessage:"No items matched current filters"})}),t.jsx(G,{variant:"secondary",startIcon:t.jsx(pt,{"aria-hidden":!0}),onClick:e,children:s({id:l("list.filters.clear"),defaultMessage:"Clear filters"})})]})},os=["folder","picture","audio","video","document"],is=["1day","3days","1week","1month","3months","6months","1year"],Oi={created:"createdAt",updated:"updatedAt"},Pi={createdAt:"created",updatedAt:"updated"},ks={exact:"isExactly",within:"withinLast",notwithin:"notWithinLast"},Bi={isExactly:"exact",withinLast:"within",notWithinLast:"notwithin"},$s={rangeis:"is",rangenot:"isNot"},Ni={is:"rangeis",isNot:"rangenot"},As=/^\d{4}-\d{2}-\d{2}$/,_i=e=>os.includes(e),Ui=e=>is.includes(e),zi=e=>{const[s,n,a]=e.split(":");if(!s||!n||!a)return null;if(s==="type"){if(n!=="is"&&n!=="not")return null;const o=a.split(",").filter(_i);return o.length>0?{kind:"type",condition:n==="is"?"is":"isNot",values:o}:null}const r=Oi[s];if(!r)return null;if(n in ks)return Ui(a)?{kind:"date",field:r,mode:"preset",condition:ks[n],preset:a}:null;if(n in $s){const[o,i]=a.split("..");return As.test(o??"")&&As.test(i??"")?{kind:"date",field:r,mode:"range",condition:$s[n],from:o,to:i}:null}return null},Ki=e=>typeof e!="string"||e===""?[]:e.split(";").map(zi).filter(s=>s!==null),Vi=e=>{if(e.kind==="type")return`type:${e.condition==="is"?"is":"not"}:${e.values.join(",")}`;const s=Pi[e.field];return e.mode==="preset"?`${s}:${Bi[e.condition]}:${e.preset}`:`${s}:${Ni[e.condition]}:${e.from}..${e.to}`},Fs=e=>e.map(Vi).join(";"),Hi=()=>{const[{query:e},s]=Ie(),n=Ki(e?.filters),a=r=>{r.length===0?s({filters:""},"remove",!0):s({filters:Fs(r)},"push",!0)};return{filters:n,serialized:Fs(n),addFilter:r=>a([...n,r]),updateFilter:(r,o)=>a(n.map((i,d)=>d===r?o:i)),removeFilter:r=>a(n.filter((o,i)=>i!==r)),clearFilters:()=>a([])}},Nt={picture:"image",audio:"audio",video:"video"},Rs=Object.values(Nt),Wi={"1day":{days:1},"3days":{days:3},"1week":{days:7},"1month":{months:1},"3months":{months:3},"6months":{months:6},"1year":{years:1}},qi=(e,s)=>{const{days:n=0,months:a=0,years:r=0}=Wi[s],o=new Date(e.getTime());if(r||a){const i=o.getDate();o.setDate(1),o.setFullYear(o.getFullYear()-r),o.setMonth(o.getMonth()-a);const d=new Date(o.getFullYear(),o.getMonth()+1,0).getDate();o.setDate(Math.min(i,d))}return o.setDate(o.getDate()-n),o},Es=e=>{const s=new Date(e.getTime());return s.setHours(0,0,0,0),s},Ts=e=>{const s=new Date(e.getTime());return s.setHours(23,59,59,999),s},dt=e=>{const[s,n,a]=e.split("-").map(Number);return new Date(s,n-1,a)},Gi=(e,s)=>{const{field:n}=e;if(e.mode==="preset"){const o=qi(s,e.preset);switch(e.condition){case"withinLast":return{[n]:{$gte:o.toISOString()}};case"notWithinLast":return{[n]:{$lt:o.toISOString()}};case"isExactly":return{[n]:{$gte:Es(o).toISOString(),$lte:Ts(o).toISOString()}}}}const a=Es(dt(e.from)).toISOString(),r=Ts(dt(e.to)).toISOString();return e.condition==="is"?{[n]:{$gte:a,$lte:r}}:{$or:[{[n]:{$lt:a}},{[n]:{$gt:r}}]}},Yi=e=>{const s=e.values.filter(r=>r!=="folder");if(s.length===0)return null;const n=s.map(r=>r==="document"?{$and:Rs.map(o=>({mime:{$notContains:o}}))}:{mime:{$contains:Nt[r]}});if(e.condition==="is")return n.length===1?n[0]:{$or:n};const a=s.map(r=>r==="document"?{$or:Rs.map(o=>({mime:{$contains:o}}))}:{mime:{$notContains:Nt[r]}});return a.length===1?a[0]:{$and:a}},Qi=(e,s)=>{const n=[],a=[];let r=!0,o=!0;for(const i of e){if(i.kind==="date"){const f=Gi(i,s);n.push(f),a.push(f);continue}const d=i.values.includes("folder");(i.condition==="is"?!d:d)&&(r=!1);const u=Yi(i);u?n.push(u):i.condition==="is"&&(o=!1)}return{fileClauses:n,folderClauses:a,showFolders:r,showFiles:o}},Zi=j.button`
  width: 3rem;
  height: 3rem;
  border: none;
  border-radius: ${({theme:e})=>e.borderRadius};
...
`,Ls=e=>{const s=`${e.getMonth()+1}`.padStart(2,"0"),n=`${e.getDate()}`.padStart(2,"0");return`${e.getFullYear()}-${s}-${n}`},Xi=e=>{const[s,n,a]=e.split("-").map(Number);return new Date(s,n-1,a)},Ji=(e,s)=>{const n=new Date(e,s,1),a=new Date(n.getTime());a.setDate(n.getDate()-(n.getDay()+6)%7);const r=[],o=new Date(a.getTime());do{const i=[];for(let d=0;d<7;d+=1)i.push(new Date(o.getTime())),o.setDate(o.getDate()+1);r.push(i)}while(o.getMonth()===s&&o.getFullYear()===e);return r},_t=({from:e,to:s,onSelect:n})=>{const{formatMessage:a,formatDate:r}=T(),o=e?Xi(e):new Date,[i,d]=c.useState(o.getFullYear()),[u,f]=c.useState(o.getMonth()),[g,h]=c.useState(null),y=g??e??null,p=g?null:s??null,m=$=>{const x=new Date(i,u+$,1);d(x.getFullYear()),f(x.getMonth())},M=$=>{const x=Ls($);if(!g){h(x);return}const[D,A]=x<g?[x,g]:[g,x];h(null),n(D,A)},v=Ji(i,u),C=v[0].map($=>r($,{weekday:"short"}).slice(0,2));return t.jsxs(_,{padding:2,width:"100%",role:"group","aria-label":a({id:l("list.filters.calendar.label"),defaultMessage:"Select date range"}),"data-testid":"date-range-calendar",children:[t.jsxs(S,{justifyContent:"space-between",alignItems:"center",paddingBottom:2,children:[t.jsx(ae,{variant:"ghost",label:a({id:l("list.filters.calendar.previous-month"),defaultMessage:"Previous month"}),onClick:()=>m(-1),children:t.jsx(Ba,{})}),t.jsx(R,{fontWeight:"semiBold",textColor:"neutral800",children:r(new Date(i,u,1),{month:"long",year:"numeric"})}),t.jsx(ae,{variant:"ghost",label:a({id:l("list.filters.calendar.next-month"),defaultMessage:"Next month"}),onClick:()=>m(1),children:t.jsx(Na,{})})]}),t.jsx(S,{children:C.map(($,x)=>t.jsx(S,{width:"3rem",height:"2.4rem",justifyContent:"center",children:t.jsx(R,{variant:"pi",fontWeight:"semiBold",textColor:"neutral600",children:$})},x))}),v.map(($,x)=>t.jsx(S,{children:$.map(D=>{const A=Ls(D),w=A===y||A===p,k=y!==null&&p!==null&&A>y&&A<p;return t.jsxs(Zi,{type:"button",$isEdge:w,$inRange:k,$isMuted:D.getMonth()!==u,onClick:()=>M(D),children:[t.jsx(De,{children:r(D,{dateStyle:"long"})}),t.jsx("span",{"aria-hidden":!0,children:D.getDate()})]},A)})},x))]})},Ut={folder:{id:l("list.filters.type.folder"),defaultMessage:"Folder"},picture:{id:l("list.filters.type.picture"),defaultMessage:"Picture"},audio:{id:l("list.filters.type.audio"),defaultMessage:"Audio"},video:{id:l("list.filters.type.video"),defaultMessage:"Video"},document:{id:l("list.filters.type.document"),defaultMessage:"Document"}},zt={"1day":{id:l("list.filters.preset.1day"),defaultMessage:"1 day ago"},"3days":{id:l("list.filters.preset.3days"),defaultMessage:"3 days ago"},"1week":{id:l("list.filters.preset.1week"),defaultMessage:"1 week ago"},"1month":{id:l("list.filters.preset.1month"),defaultMessage:"1 month ago"},"3months":{id:l("list.filters.preset.3months"),defaultMessage:"3 months ago"},"6months":{id:l("list.filters.preset.6months"),defaultMessage:"6 months ago"},"1year":{id:l("list.filters.preset.1year"),defaultMessage:"1 year ago"}},Kt={createdAt:{id:l("list.filters.field.created"),defaultMessage:"Creation date"},updatedAt:{id:l("list.filters.field.updated"),defaultMessage:"Last modified"}},kt=j(B.SubTrigger)`
  width: 100%;
  justify-content: space-between;
`,Fe="24.2rem",$t="70dvh",el=`min(${Fe}, calc(100dvw - 2rem))`,At=j(B.Item)`
  width: 100%;
`,Os=j(_)`
  width: 100%;
...
`,tl=j(Ua)`
  ...
  min-width: auto;
  padding: 0 0.4rem;
`,sl=({listFilters:e})=>{const{formatMessage:s}=T(),{trackUsage:n}=$e(),[a,r]=c.useState(!1),{filters:o,addFilter:i,updateFilter:d,removeFilter:u}=e,f=b=>n("didFilterMediaLibraryElements",{location:ee,filter:b});let g=-1;for(let b=o.length-1;b>=0;b-=1)if(o[b].kind==="type"){g=b;break}const h=g>=0?o[g]:null,y=h&&h.kind==="type"?h.values:[],p=b=>{const I=!y.includes(b),F=I?[...y,b]:y.filter(U=>U!==b);I&&f("type"),h&&h.kind==="type"?F.length===0?u(g):d(g,{...h,values:F}):F.length>0&&i({kind:"type",condition:"is",values:F})},m=(b,I)=>{f(b);for(let F=o.length-1;F>=0;F-=1){const U=o[F];if(U.kind==="date"&&U.mode==="preset"&&U.field===b){d(F,{...U,preset:I});return}}i({kind:"date",field:b,mode:"preset",condition:"withinLast",preset:I})},M=(b,I)=>{f("createdAt"),i({kind:"date",field:"createdAt",mode:"range",condition:"is",from:b,to:I}),r(!1)},v=rn(),[C,$]=c.useState(null),[x,D]=c.useState(!1),A=b=>{r(b),b||($(null),D(!1))},w=b=>{$(I=>I===b?null:b),D(!1)},k=os.map(b=>t.jsx(B.Item,{role:"menuitemcheckbox","aria-checked":y.includes(b),onSelect:I=>{I.preventDefault(),p(b)},startIcon:t.jsx(ke,{checked:y.includes(b),tabIndex:-1,"aria-hidden":!0}),children:s(Ut[b])},b)),N=b=>{for(let I=o.length-1;I>=0;I-=1){const F=o[I];if(F.kind==="date"&&F.mode==="preset"&&F.field===b)return F.preset}return null},E=b=>{const I=N(b);return is.map(F=>t.jsx(B.Item,{role:"menuitemradio","aria-checked":I===F,onSelect:()=>{m(b,F)},endIcon:I===F?t.jsx(ft,{"aria-hidden":!0,width:"1.6rem",height:"1.6rem",fill:"primary600"}):null,children:s(zt[F])},F))},Y=s({id:l("list.filters.field.type"),defaultMessage:"Type"}),L=s({id:l("list.filters.select-date-range"),defaultMessage:"Select date range"});return t.jsxs(B.Root,{open:a,onOpenChange:A,children:[t.jsx(B.Trigger,{variant:"tertiary",startIcon:t.jsx(_a,{"aria-hidden":!0}),endIcon:null,children:t.jsxs(S,{gap:2,alignItems:"center",tag:"span",children:[s({id:l("list.filters.trigger"),defaultMessage:"Filter"}),o.length>0&&t.jsx(tl,{children:o.length})]})}),t.jsx(B.Content,{popoverPlacement:"bottom-start",zIndex:2,maxHeight:$t,width:v?el:Fe,children:v?t.jsxs(t.Fragment,{children:[t.jsx(At,{"aria-expanded":C==="type",onSelect:b=>{b.preventDefault(),w("type")},endIcon:t.jsx(Ft,{$open:C==="type","aria-hidden":!0}),children:Y}),C==="type"&&t.jsx(Os,{children:k}),["createdAt","updatedAt"].map(b=>t.jsxs(_,{width:"100%",children:[t.jsx(At,{"aria-expanded":C===b,onSelect:I=>{I.preventDefault(),w(b)},endIcon:t.jsx(Ft,{$open:C===b,"aria-hidden":!0}),children:s(Kt[b])}),C===b&&t.jsxs(Os,{children:[E(b),b==="createdAt"&&t.jsxs(t.Fragment,{children:[t.jsx(At,{"aria-expanded":x,onSelect:I=>{I.preventDefault(),D(F=>!F)},endIcon:t.jsx(Ft,{$open:x,"aria-hidden":!0}),children:L}),x&&t.jsx(_,{paddingLeft:2,children:t.jsx(_t,{onSelect:M})})]})]})]},b))]}):t.jsxs(t.Fragment,{children:[t.jsxs(B.SubRoot,{children:[t.jsx(kt,{children:Y}),t.jsx(Rt,{zIndex:2,maxHeight:$t,width:Fe,children:k})]}),["createdAt","updatedAt"].map(b=>t.jsxs(B.SubRoot,{children:[t.jsx(kt,{children:s(Kt[b])}),t.jsxs(Rt,{zIndex:2,maxHeight:$t,width:Fe,children:[E(b),b==="createdAt"&&t.jsxs(B.SubRoot,{children:[t.jsx(kt,{children:L}),t.jsx(Rt,{zIndex:2,maxHeight:"none",width:Fe,children:t.jsx(_t,{onSelect:M})})]})]})]},b))]})})]})},nl=j(S)`
...
`,Kl=()=>{const{formatMessage:e}=T(),{openDetails:s}=vn(),{canCreate:n,canUpdate:a}=ce(),{currentFolderId:r,navigateToFolderId:o,navigateToRoot:i}=He(),{error:d}=Xt({id:r},{skip:r===null});c.useEffect(()=>{d?.name==="NotFoundError"&&i()},[d,i]);const{title:u,itemCount:f}=xn(r),{searchQuery:g,isSearching:h,clearSearch:y}=Nn(),p=Il(),m=Hi(),M=c.useMemo(()=>Qi(m.filters,new Date),[m.serialized]),{assets:v,subscribers:C,pagination:$,isLoading:x,isFetchingMore:D,hasNextPage:A,fetchNextPage:w,error:k}=Cl({folder:r,search:g||void 0,sort:p.assetsSort,filters:M.fileClauses,enabled:M.showFiles}),{data:N=[],isLoading:E}=Mr({parentId:r,search:g||void 0,sort:p.foldersSort,filters:M.folderClauses},{skip:!M.showFolders}),Y=c.useMemo(()=>M.showFolders?N:[],[M.showFolders,N]),L=c.useMemo(()=>vr(v,Y),[v,Y]),b=e(Rl,{count:f}),I=e({id:l("header.search-results"),defaultMessage:'Search results for "{query}"'},{query:g}),F=Y.length,U=$?.total??0,V=e(El(F,U),{numberFolders:F,numberAssets:U});let H;h?H=`${I} (${V})`:u?H=`${u} (${b})`:H=e({id:"app.loading",defaultMessage:"Loading..."});const[P,q]=c.useState(!1),[Q,ie]=Ys(pi.view,Ne.GRID),xe=Q===Ne.GRID,[ge,We]=c.useState(!1),qe=c.useRef(null),Le=c.useRef(null),[le,Oe]=c.useState(!1),Ge=c.useCallback(J=>Oe(!J),[]),O=qa(Ge,Fl),[W]=Ga(),[K]=Ya(),{data:se}=Qt(),ne=se?.data?.concurrentUploadRequests??1,pe=mt(),{trackUsage:re}=$e(),Ye=async(J,Pe)=>{if(J.length===0)return;const ea=J.reduce((Ae,ta)=>{const ps=sr(ta.type);return Ae[ps]=(Ae[ps]??0)+1,Ae},{});re("willAddMediaLibraryAssets",{location:ee,...ea});const jt=new FormData,gs=[];J.forEach(Ae=>{jt.append("files",Ae),gs.push({name:Ae.name,caption:null,alternativeText:null,folder:Pe})}),jt.append("fileInfo",JSON.stringify(gs));try{await W({formData:jt,totalFiles:J.length,concurrency:ne,generateAiMetadata:!!pe}).unwrap()}catch{}},Qe=()=>{qe.current?.click()},yt=async J=>{const Pe=J.target.files;Pe&&Pe.length>0&&(re("didSelectFile",{source:"computer",location:ee}),await Ye(Array.from(Pe),r)),J.target.value=""},bt=async J=>{n&&(re("didSelectFile",{source:"computer",location:ee}),await Ye(J,r))},Xn=async J=>{re("didSelectFile",{source:"url",location:ee}),re("willAddMediaLibraryAssets",{location:ee});try{await K({urls:J,folderId:r,generateAiMetadata:!!pe}).unwrap()}catch{}},Jn=Dl({folderId:r,search:g,sort:`${p.assetsSort};folders=${p.foldersPosition}`,filter:m.serialized||null});return t.jsxs(t.Fragment,{children:[t.jsx(ki,{onDrop:bt,disabled:!n,children:t.jsx(vo,{disabled:!a,children:t.jsx(Io,{children:t.jsxs(Ho,{locations:L,children:[t.jsx(Ll,{listQueryKey:Jn}),t.jsx(hs.Root,{sideNav:t.jsx(xl,{currentFolderId:r,showActiveFolder:!h,onSelectFolder:o}),children:t.jsx(ln.Main,{children:t.jsxs(_,{ref:Le,children:[t.jsx(De,{children:t.jsx("input",{type:"file",ref:qe,onChange:yt,multiple:!0})}),t.jsx(_,{ref:O,height:0,"aria-hidden":!0}),t.jsxs(Pl,{$compact:le,children:[t.jsxs(Bl,{children:[t.jsx(R,{variant:"alpha",tag:"h1",children:H}),n&&t.jsxs(Qa,{popoverPlacement:"bottom-end",variant:"default",endIcon:t.jsx(ht,{}),label:e({id:l("new"),defaultMessage:"New"}),children:[t.jsx(Mt,{onSelect:()=>q(!0),startIcon:t.jsx(ve,{}),children:e({id:l("folder.create.title"),defaultMessage:"New folder"})}),t.jsx(Mt,{onSelect:Qe,startIcon:t.jsx(Za,{}),children:e({id:l("import-files"),defaultMessage:"Import files"})}),t.jsx(Mt,{onSelect:()=>We(!0),startIcon:t.jsx(ze,{}),children:e({id:l("import-from-url"),defaultMessage:"Import from URL"})})]})]}),t.jsxs(Nl,{$compact:le,children:[t.jsxs(_l,{children:[t.jsx(_,{children:t.jsx(sl,{listFilters:m})}),t.jsx(zl,{children:t.jsx(gi,{})})]}),t.jsxs(Ul,{children:[t.jsx(_,{children:t.jsx(jl,{sort:p,showFoldersGroup:!xe})}),t.jsxs(Ol,{type:"single",value:xe?"grid":"table",onValueChange:J=>J&&ie(J==="grid"?Ne.GRID:Ne.TABLE),"aria-label":e({id:l("view.switch.label"),defaultMessage:"View options"}),children:[t.jsxs(qs,{value:"table","aria-label":e({id:l("view.table"),defaultMessage:"Table view"}),children:[t.jsx(Xa,{}),t.jsx(Gs,{children:e({id:l("view.table"),defaultMessage:"Table view"})})]}),t.jsxs(qs,{value:"grid","aria-label":e({id:l("view.grid"),defaultMessage:"Grid view"}),children:[t.jsx(Ja,{}),t.jsx(Gs,{children:e({id:l("view.grid"),defaultMessage:"Grid view"})})]})]})]})]}),t.jsx(dl,{listFilters:m,compact:le})]}),t.jsxs(hs.Content,{children:[t.jsx(gr,{}),C,t.jsxs(Fi,{children:[t.jsx(Ei,{uploadDropZoneRef:Le,folderName:u}),t.jsx(Tl,{view:Q,folders:Y,isLoadingFolders:E,assets:v,isLoadingAssets:x,isFetchingMore:D,hasNextPage:A,fetchNextPage:w,error:k,locations:L,searchQuery:g,assetsSort:p.assetsSort,foldersPosition:p.foldersPosition,hasActiveFilters:m.filters.length>0,onClearFilters:m.clearFilters,onAssetItemClick:s,onAddAssets:Qe,canAddAssets:n,onClearSearch:y})]})]})]})})})]})})})}),t.jsx(Pn,{open:P,mode:"create",parentFolderName:u,parentFolderId:r,onClose:()=>q(!1)}),t.jsx(yl,{open:ge,onClose:()=>We(!1),onUpload:Xn}),t.jsx(xo,{})]})},Gl=()=>{const{formatMessage:e}=T(),s=e({id:l("plugin.name"),defaultMessage:"Media Library"});return t.jsxs(t.Fragment,{children:[t.jsx(ln.Title,{children:s}),t.jsx(nr,{children:t.jsx(ar,{index:!0,element:t.jsx(Kl,{})})})]})};export{Gl as BetaMediaLibrary};
