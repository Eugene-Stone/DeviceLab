  ...
  attributes: {
    ...
    tags: Schema.Attribute.JSON &
      Schema.Attribute.CustomField<
        ...
        {
          apiUrl: '/api/article-tags?fields[0]=title';
        }
      >;
...
export interface ApiFormRequestFormRequest extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    formDataJSON: Schema.Attribute.JSON;
...
export interface ApiGlobalGlobal extends Struct.SingleTypeSchema {
  ...
  attributes: {
    contacts: Schema.Attribute.Component<'shared.single-field', true>;
    copyright: Schema.Attribute.Text;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    footerSlogan: Schema.Attribute.Text;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::global.global'
    ...
    logoHeader: Schema.Attribute.Media<'images'> & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    seo: Schema.Attribute.Component<'shared.seo', false>;
    socials: Schema.Attribute.Component<'shared.social-link', true>;
    title: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'Global data'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiProductOrderProductOrder
  ...
  attributes: {
    buyerDetails: Schema.Attribute.Component<'products.buyer-details', false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    acceptedTermsAt: Schema.Attribute.String;
    ...
    firstName: Schema.Attribute.String;
    form_requests: Schema.Attribute.Relation<
      'oneToMany',
      'api::form-request.form-request'
    >;
    lastName: Schema.Attribute.String;
